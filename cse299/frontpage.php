...
elseif ($redirect=="doctor"){
	$_SESSION['USER_VALUE'] = $user_id;
	header("Location: After login doctor.php");
	...
	$_SESSION['USER_VALUE'] = $user_id;
	header("Location: After login patients.php");
	}
...
<div class="topnav">
	...
	<div class="signup-container">
		 <form method="POST" action="frontpage.php">
	<button type="submit"><a href="signup page.php">Signup Patient</a></button>
	<button type="submit"><a href="signup page.d.php">Signup Doctor</a></button>
	</div>
